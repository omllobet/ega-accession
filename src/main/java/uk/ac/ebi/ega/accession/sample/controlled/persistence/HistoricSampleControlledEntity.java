...
@Entity
public class HistoricSampleControlledEntity extends InactiveAccessionEntity<SampleControlled, Long> implements SampleControlled {
    ...
    HistoricSampleControlledEntity() {
        super();
    }

    public HistoricSampleControlledEntity(SampleControlledEntity entity) {
        super(entity);
