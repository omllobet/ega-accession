...
@Entity
public class SampleOpenEntity extends AccessionedEntity<SampleOpen, Long> implements SampleOpen {
    ...
    public SampleOpenEntity(SampleOpen sampleOpen, Long accession, String hashedMessage, int version) {
        super(hashedMessage, accession, version);
        biosampleAccession = sampleOpen.getBiosampleAccession();
    }

    public SampleOpenEntity(AccessionWrapper<SampleOpen, String, Long> wrapper) {
