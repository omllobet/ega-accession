...
import uk.ac.ebi.ega.accession.file.persistence.HistoricLogRepository;
...
public class FileServiceConfiguration {
    ...
    @Autowired
    private HistoricLogRepository historicLogRepository;

    @Bean
    public AccessioningService<FileModel, String, String> egafFileAccessionService() {
        return DecoratedAccessioningService.buildPrefixPaddedLongAccessionService(fileAccessionService(), "EGAF",
                "%011d", Long::parseLong);
    }
    ...
    public AccessioningService<FileModel, String, Long> fileAccessionService() {
        return new BasicAccessioningService<>(
                new MonotonicAccessionGenerator<>("file", "ega-accession-01", blockService, monotonicDatabaseService()),
