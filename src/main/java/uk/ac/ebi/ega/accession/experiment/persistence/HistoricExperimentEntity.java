...
@Entity
public class HistoricExperimentEntity extends InactiveAccessionEntity<Experiment, Long> implements Experiment {
    ...
    HistoricExperimentEntity() {
        super();
    }

    public HistoricExperimentEntity(ExperimentEntity entity) {
        super(entity);
